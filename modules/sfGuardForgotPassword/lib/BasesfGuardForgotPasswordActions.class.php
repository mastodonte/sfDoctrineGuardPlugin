  ...
  public function executeIndex($request)
  {
    ...
    if ($request->isMethod('post'))
    {
      ...
      if ($this->form->isValid())
      {
        ...
        {
          return $this->renderText(mdBasicFunction::basic_json_response(true, array('message' => 'Check your e-mail! You should receive something shortly!')));
        } else{
        ...
        if ($request->isXmlHttpRequest())
        {
          return $this->renderText(mdBasicFunction::basic_json_response(false, array('message' => 'Invalid e-mail address!')));
        } else{
